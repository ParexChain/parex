...
5. [Public Release Notes](#public-release-notes)
...
### DexTracker
- parex Node Minimum Requirements: **`4 Core`** of CPU **`8GB`** of Memory and **`700GB`** of SSD
...
### MasterTracker
- parex Node Minimum Requirements: **`8 Core`** of CPU **`16GB`** of Memory and **`700GB`** of SSD
- Tested Operation Systems `Windows Server 2016 or Later` || `Centos` || `Ubuntu` || `Amazon Linux`
